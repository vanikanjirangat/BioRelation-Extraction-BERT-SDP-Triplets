...
#                print(len(items))
                ...
                if len(intra)>1:
                    ...
                    # If I can't find the path length, by default I take first sentence as sample
                    else:
                        sel_intra=intra[0]
...
#                self.samples=list(set(self.samples))
    ...
    def write_path(self):
        ...
        full1=os.path.join(self.opath,'train1.tsv')
...
#                            help='Folder name training.')
        '''
        Path where dinput data is stored
        '''
        ...
        '''
        Path where generated output data has to be stored
        '''
        parser.add_argument('--opath', type=str, default='DATA_EVAL/train',
...
'''
For development, change the  argument as CDR_DevelopmentSet.PubTator
FOr test set, CDR_TestSet.PubTator
'''
data=m.extract_data('CDR_TrainingSet.PubTator.txt')
